...
namespace VFrame30
{
	class DiagStateController : public QObject
	{
		Q_OBJECT

	public:
		explicit DiagStateController(IDiagStateManager& diagStateManager, QObject* parent = nullptr);
	...
	public:
		[[nodiscard]] IDiagStateManager& diagStateManager();
		[[nodiscard]] const IDiagStateManager& diagStateManager() const;

	private:
		IDiagStateManager& m_diagStateManager;
	};
	...
	/*! \class ScriptAppSignalController
		...
		\endcode
	*/
	class ScriptDiagStateController : public QObject
	{
		Q_OBJECT

	public:
		explicit ScriptDiagStateController(const IDiagStateManager& diagStateManager, QObject* parent = nullptr);
		virtual ~ScriptDiagStateController();
	...
	public slots:
		...
		//
	private:
		const IDiagStateManager& m_diagStateManager;
	};
