...
namespace VFrame30
{
	...
	{
		ADD_PROPERTY_GET_SET_CAT(double, LineWeight, tr("Appearance"), true, SchemaItemLine::weight, SchemaItemLine::setWeight);
		ADD_PROPERTY_GET_SET_CAT(QColor, LineColor, tr("Appearance"), true, SchemaItemLine::lineColor, SchemaItemLine::setLineColor);
