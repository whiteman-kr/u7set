...
public:
    ...
    enum AlternateRowMode { Disabled=0, Odd, Even };
    ...
    void setAlternateRowBackgroundMode( AlternateRowMode mode ) { m_altBackMode = mode; }
    AlternateRowMode alternateRowBackgroundMode() { return m_altBackMode; }

    void setAlternateRowBackgroundColor( const QColor& color ) { m_altBackColor = color; }
    QColor alternateRowBackgroundColor() const { return m_altBackColor; }

    void setUseDefaultAlternateRowColor( bool set );
    bool useDefaultAlternateRowColor() const;
...
private:
    ...
    AlternateRowMode m_altBackMode;
    QColor m_altBackColor;
    bool m_useDefaultAltBackColor;
private:
