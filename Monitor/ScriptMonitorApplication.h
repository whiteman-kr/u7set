...
*/
class ScriptMonitorApplication : public QObject
{
	Q_OBJECT
...
public:
	...
	void setMainWindow(MonitorMainWindow* mainWindow);
	MonitorMainWindow* mainWindow();
	const MonitorMainWindow* mainWindow() const;
