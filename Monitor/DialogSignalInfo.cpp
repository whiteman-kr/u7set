	...
	ui(new Ui::DialogSignalInfo)
{
	...
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("AppSignalID")<<m_signal.appSignalID()));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("EquipmentID")<<m_signal.equipmentID()));
	...
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("Calculated")<<(m_signal.calculated() ? tr("Yes") : tr("No"))));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("Acquire")<<(m_signal.acquire() ? tr("Yes") : tr("No"))));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("NormalState")<<QString::number(m_signal.normalState())));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("DecimalPlaces")<<QString::number(m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("UnbalanceLimit")<<QString::number(m_signal.unbalanceLimit(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("Aperture")<<QString::number(m_signal.aperture(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("FilteringTime")<<QString::number(m_signal.filteringTime(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("SpreadTolerance")<<QString::number(m_signal.spreadTolerance(), 'f', m_signal.decimalPlaces())));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<"-"<<"-"));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("LowADC")<<QString::number(m_signal.lowADC())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("HighADC")<<QString::number(m_signal.highADC())));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("LowEngineeringUnits")<<QString::number(m_signal.lowEngeneeringUnits(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("HighEngineeringUnits")<<QString::number(m_signal.highEngeneeringUnits(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("LowValidRange")<<QString::number(m_signal.lowValidRange(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("HighValidRange")<<QString::number(m_signal.highValidRange(), 'f', m_signal.decimalPlaces())));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<"-"<<"-"));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("InputLowLimit")<<QString::number(m_signal.inputLowLimit(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("InputHighLimit")<<QString::number(m_signal.inputHighLimit(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("InputUnitID")<<QString::number(m_signal.inputUnitID())));
	...
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("InputSensorID")<<str));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<"-"<<"-"));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("OutputLowLimit")<<QString::number(m_signal.outputLowLimit(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("OutputHighLimit")<<QString::number(m_signal.outputHighLimit(), 'f', m_signal.decimalPlaces())));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("OutputUnitID")<<QString::number(m_signal.outputUnitID())));
	...
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("OutputSensorID")<<str));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("OutputMode")<<E::valueToString<E::OutputMode>(m_signal.outputModeInt())));

	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<"-"<<"-"));


	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("EnableTuning")<<(m_signal.enableTuning() ? tr("Yes") : tr("No"))));
	ui->treeProperties->insertTopLevelItem(i++, new QTreeWidgetItem(QStringList()<<tr("TuningDefaultValue")<<QString::number(m_signal.tuningDefaultValue())));
