...
namespace ReportLib
{
	//
	//
	// ReportDiagStateProvider - this class is used to provide diag data for drawing schemas, showing and getting object ids, description, precision, etc...
	//
	//
	class ReportDiagStateProvider final : public IDiagStateManager
	{
	public:
		ReportDiagStateProvider(/*const AppSignalSet* signalSet*/);
