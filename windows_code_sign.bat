...
"%SIGNTOOL%" sign /v /a /t http://time.certum.pl/ /fd SHA512 ./bin/release/AppDataSrv.exe ./bin/release/ArchSrv.exe ./bin/release/CfgSrv.exe ./bin/release/mconf.exe ./bin/release/Metrology.exe ./bin/release/Monitor.exe ./bin/release/scm.exe ./bin/release/TuningClient.exe ./bin/release/TuningSrv.exe ./bin/release/u7.exe ./bin/release/SimulatorTests.exe ./bin/release/SimulatorConsole.exe ./bin/release/BuilderConsole.exe ./bin/release/TestSuite.exe ./bin/release/TestSuiteConsole.exe
