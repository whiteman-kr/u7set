-- RPCT-824
-- Add TuningDefaultValue field to signals

-- Add field TuningDefaultValue

ALTER TABLE SignalInstance ADD COLUMN tuningdefaultvalue double precision NOT NULL DEFAULT 0;
