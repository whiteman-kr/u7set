...
TestLibrary::TestLibrary(const SoftwareInfo& softwareInfo, const TestLibrarySettings& settings, ILogFile* appLogFile, IOutputLog* outputLog):
	HasLogFile(appLogFile, "TestLibrary"),
	m_librarySettings(settings),
	m_configController(softwareInfo, settings.configuratorAddress1(), settings.configuratorAddress2(), appLogFile),
	m_testLog(outputLog),
