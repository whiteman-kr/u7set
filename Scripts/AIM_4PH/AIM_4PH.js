...
function generate_aim4ph(confFirmware, module, LMNumber, frame, log, signalSet, opticModuleStorage)
{
    ...
    for (let i = 0; i < AIMSignalMaxCount; i++)
    {
        ...
        if (signalA == null)
        {
            ...
            if (setData16(confFirmware, log, LMNumber, module.equipmentId, frame, ptr, "WordOfFlags", 0) == false)      // InA DefaultWordOfFlags
			{
				return false;
			}
            ptr += 2;
        ...
        else
        {
			...
			if (rload != rloadB)
			{
				log.errCFG3028(signalStrIdA, signalStrIdB, module.equipmentId, "Rload_Ohm");
			}
