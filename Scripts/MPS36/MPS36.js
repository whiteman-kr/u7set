// Generate configuration for module MPS-36
//
//
		
function generate_mps36(confFirmware, module, LMNumber, frame, log, signalSet, opticModuleStorage)
{
	var Mode_420mA = 1;
	var Mode_020mA = 4;
	var Mode_024mA = 5;
	...
	var defaultFlags = [0x2, 0x2, 0x2, 0x2, 0xe, 0xe, 0xe, 0xe, 0xe, 0xe];
    ...
    var defaultHighBound = [100, 100, 100, 100];
