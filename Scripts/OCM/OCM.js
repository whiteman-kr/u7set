...
function generate_ocm(confFirmware, module, LMNumber, frame, log, signalSet, opticModuleStorage)
{
	let Mode_RS232 = 0;
	let Mode_RS485 = 1;
	...
	for (let p = 0; p < portCount; p++)
	{
		...
		if (optoPort.enableSerial() == true)
		{
			...
			{
				confFirmware.writeLog("    This OCM version does not support duplex mode (enableDuplex property)!");
				log.writeError("    This OCM version does not support duplex mode (enableDuplex property)!");
				return false;
			}
