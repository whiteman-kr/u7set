...
namespace Tuning
{
	...
	public:
		...
		bool clientIsConnected(const SoftwareInfo& softwareInfo);
		bool clientIsDisconnected(const SoftwareInfo& softwareInfo);
		bool setActiveClient(const SoftwareInfo& softwareInfo);
