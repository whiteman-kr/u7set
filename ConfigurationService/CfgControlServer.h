...
public slots:
	void updateClientsInfo(std::list<Tcp::ConnectionState> connectionStates) { m_connectionStates = connectionStates; }
...
private:
	...
	static std::list<Tcp::ConnectionState> m_connectionStates;
