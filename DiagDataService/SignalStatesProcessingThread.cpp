...
SignalStatesProcessingThread::SignalStatesProcessingThread(DynamicDiagSignalStates& signalStates,
...
void SignalStatesProcessingThread::processStates(DiagDataReceiver& receiver)
{
