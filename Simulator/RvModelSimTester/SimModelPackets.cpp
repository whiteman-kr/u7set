...
// RC16 calculating function (x^16 + x^12 + x^2 + 1)
//
//extern uint16_t calcCrc16(const void* buf, int len)
//{
...
//	{
//		crc = (crc >> 8) ^ crc16tab[(crc ^ (uint16_t)(*ptr++)) & 0x00FF];
//	}
//
//	return crc;
//}
//
//extern Hash calcHash(const char* str)
//{
//	Hash hash = 0;
...
extern const char* errorCodeToString(enum ErrorCode code)
{
	switch (code)
	{
...
extern const char* simStateToString(enum SimulatorStateCode code)
{
	switch (code)
	{
