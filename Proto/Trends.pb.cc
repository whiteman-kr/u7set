...
constexpr TrendStateRecord::TrendStateRecord(
  ...
  : states_raw_buffer_v2_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
constexpr TrendSignalParam::TrendSignalParam(
  ...
  , analog_format_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , type_(0)
  , precision_(0)
  , line_weight_(0)
  , high_limit_(0)
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Trends_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Proto::TrendStateRecord, states_raw_buffer_v2_),
  1,
  0,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::Proto::TrendStateRecord)},
  { 9, 17, sizeof(::Proto::TrendArchiveHour)},
  { 20, 28, sizeof(::Proto::TrendArchive)},
  { 31, 39, sizeof(::Proto::TrendViewLimit)},
  { 42, 66, sizeof(::Proto::TrendSignalParam)},
  { 85, -1, sizeof(::Proto::TrendSignalSet)},
  { 94, 102, sizeof(::Proto::TrendRuler)},
  { 105, -1, sizeof(::Proto::TrendRulerSet)},
  { 111, 118, sizeof(::Proto::Trend)},
  { 120, 133, sizeof(::Proto::TrendParam)},
  { 141, 148, sizeof(::Proto::TrendWidget)},
};
...
const char descriptor_table_protodef_Trends_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Trends.proto\022\005Proto\"N\n\020TrendStateRecor"
  "d\022\034\n\024states_raw_buffer_v1\030\004 \001(\014\022\034\n\024state"
  "s_raw_buffer_v2\030\003 \001(\014\"_\n\020TrendArchiveHou"
  "r\022\022\n\ntime_stamp\030\002 \001(\006\022\r\n\005state\030\003 \001(\005\022(\n\007"
  "records\030\004 \003(\0132\027.Proto.TrendStateRecord\"h"
  "\n\014TrendArchive\022\025\n\rapp_signal_id\030\002 \001(\t\022\031\n"
  "\021archive_server_id\030\003 \001(\t\022&\n\005hours\030\n \003(\0132"
  "\027.Proto.TrendArchiveHour\"E\n\016TrendViewLim"
  "it\022\014\n\004type\030\001 \001(\005\022\022\n\nhigh_limit\030\002 \001(\001\022\021\n\t"
  "low_limit\030\003 \001(\001\"\271\003\n\020TrendSignalParam\022\021\n\t"
  ...
  "vice_short_id\030\007 \001(\t\022\027\n\017data_service_id\030\010"
  " \001(\t\022\014\n\004type\030\n \001(\005\022\014\n\004unit\030\013 \001(\t\022\014\n\004tags"
  "\030\r \003(\t\022\021\n\tprecision\030\014 \001(\005\022\026\n\013line_weight"
  "\030\023 \001(\001:\0010\022\022\n\nhigh_limit\030\024 \001(\001\022\021\n\tlow_lim"
  "it\030\025 \001(\001\022\027\n\017view_high_limit\030\037 \001(\001\022\026\n\016vie"
  "w_low_limit\030  \001(\001\022*\n\013view_limits\030! \003(\0132\025"
  ".Proto.TrendViewLimit\022\r\n\005color\030( \001(\r\022\025\n\r"
  "analog_format\030) \001(\t\"\324\001\n\016TrendSignalSet\022."
  ...
  "\003 \001(\0132\024.Proto.TrendRulerSet\"\274\001\n\nTrendPar"
  ...
  "cale_type\030\005 \001(\005:\0010\"R\n\013TrendWidget\022\033\n\005tre"
  "nd\030\002 \001(\0132\014.Proto.Trend\022&\n\013trend_param\030\003 "
  "\001(\0132\021.Proto.TrendParam"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Trends_2eproto = {
  false, false, 1542, descriptor_table_protodef_Trends_2eproto, "Trends.proto", 
...
class TrendStateRecord::_Internal {
 public:
  ...
  static void set_has_states_raw_buffer_v2(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};
...
TrendStateRecord::TrendStateRecord(const TrendStateRecord& from)
  ...
  states_raw_buffer_v2_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_states_raw_buffer_v2()) {
    states_raw_buffer_v2_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_states_raw_buffer_v2(), 
      GetArena());
  }
...
void TrendStateRecord::SharedDtor() {
  ...
  states_raw_buffer_v2_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:Proto.TrendStateRecord)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      states_raw_buffer_v2_.ClearNonDefaultToEmpty();
    }
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          auto str = _internal_mutable_states_raw_buffer_v2();
...
::PROTOBUF_NAMESPACE_ID::uint8* TrendStateRecord::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->WriteBytesMaybeAliased(
        3, this->_internal_states_raw_buffer_v2(), target);
  }
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(
          this->_internal_states_raw_buffer_v2());
    }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Proto.TrendStateRecord)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_states_raw_buffer_v2(from._internal_states_raw_buffer_v2());
    }
    if (cached_has_bits & 0x00000002u) {
...
void TrendStateRecord::InternalSwap(TrendStateRecord* other) {
  ...
  states_raw_buffer_v2_.Swap(&other->states_raw_buffer_v2_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
TrendSignalParam::TrendSignalParam(const TrendSignalParam& from)
  ...
  analog_format_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_analog_format()) {
    analog_format_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_analog_format(), 
      GetArena());
  }
...
void TrendSignalParam::SharedDtor() {
  ...
  analog_format_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:Proto.TrendSignalParam)
  ...
  if (cached_has_bits & 0x00000100u) {
    analog_format_.ClearNonDefaultToEmpty();
  }
...
void TrendSignalParam::InternalSwap(TrendSignalParam* other) {
  ...
  analog_format_.Swap(&other->analog_format_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
