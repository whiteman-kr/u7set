...
namespace ClientLib
{
	AdsSourceStateConnectionPrivate::Connection::Connection(const SoftwareInfo& softwareInfo,
	...
	AdsSourceStateConnectionPrivate::Connection::~Connection()
	{
		stopAndDestroy();
		return;
	}

	void AdsSourceStateConnectionPrivate::Connection::stopAndDestroy()
	{
	...
	HostAddressPort AdsSourceStateConnectionPrivate::Connection::address() const
	{
	...
	AdsSourceStateConnectionPrivate::AdsSourceStateConnectionPrivate(ILogFile* logFile) :
		m_logFile(logFile, "AdsConnection")
	{
		return;
	}

	void AdsSourceStateConnectionPrivate::updateConnections(const SoftwareInfo& softwareInfo, const std::vector<SoftwareEndpoint::AppDataService>& appDataService)
	{
	...
	std::vector<Tcp::ConnectionState> AdsSourceStateConnectionPrivate::adsConnectionStates() const
	{
	...
	std::vector<ClientLib::AppDataSourceState> AdsSourceStateConnectionPrivate::appDataSourceStates() const
	{
	...
	void AdsSourceStateConnectionPrivate::createAndStart(const SoftwareInfo& softwareInfo, const std::vector<SoftwareEndpoint::AppDataService>& appDataService)
	{
