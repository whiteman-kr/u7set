...
namespace TestSuite
{
	class ConstStrings : public QObject
	{
		Q_OBJECT
	public:
		static QString TEST_PASSED() { return tr("PASSED"); }
		static QString TEST_FAILED() { return tr("FAILED"); }
		static QString TEST_RUNNING() { return tr("RUNNING"); }
		static QString TEST_ALLOWED() { return tr("Allowed"); }
		static QString TEST_DENIED() { return tr("Denied"); }
	};
	...
	public:
		...
		virtual void logItemArrived(const ::TestSuite::TestLogItem& item) = 0;
	};
	...
	private:
		...
		mutable QReadWriteLock m_itemsLock; // For access to m_items
