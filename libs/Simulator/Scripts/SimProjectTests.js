...
// Schema: TEST_FUNC_V5
//
function testAfbFuncV5(sim)
{
	// V5 tested just added configurations 9 - 13
	// math_sign_inv_fp
	// math_sign_inv_si
	//
	// math_negate_fp_v1
	...
	// conf 9 -> math_sign_inv_fp
	//
	assert(sim.signalValue("#TEST_FUNC_V5_C9_T1_RESULT") === -9);
	assert(sim.signalValue("#TEST_FUNC_V5_C9_T1_RZ") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C9_T1_RNAN") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C9_T2_RESULT") === 9);
	assert(sim.signalValue("#TEST_FUNC_V5_C9_T2_RZ") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C9_T2_RNAN") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C9_T3_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C9_T3_RZ") === 1);
	assert(sim.signalValue("#TEST_FUNC_V5_C9_T3_RNAN") === 0);

	// conf 10 -> math_sign_inv_si
	//
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T1_RESULT") === 100);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T1_ROV") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T1_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C10_T2_RESULT") === -100);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T2_ROV") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T2_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C10_T3_RESULT") === -2147483647);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T3_ROV") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T3_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C10_T4_RESULT") === 2147483647);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T4_ROV") === 1);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T4_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C10_T5_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T5_ROV") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C10_T5_RZ") === 1);

	// conf 11 -> math_negate_fp
	//
	assert(sim.signalValue("#TEST_FUNC_V5_C11_T1_RESULT") === -9);
	assert(sim.signalValue("#TEST_FUNC_V5_C11_T1_RZ") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C11_T1_RNAN") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C11_T2_RESULT") === -9);
	assert(sim.signalValue("#TEST_FUNC_V5_C11_T2_RZ") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C11_T2_RNAN") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C11_T3_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C11_T3_RZ") === 1);
	assert(sim.signalValue("#TEST_FUNC_V5_C11_T3_RNAN") === 0);

	// conf 12 -> math_negate_si
	//
	assert(sim.signalValue("#TEST_FUNC_V5_C12_T1_RESULT") === -100);
	assert(sim.signalValue("#TEST_FUNC_V5_C12_T1_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C12_T2_RESULT") === -100);
	assert(sim.signalValue("#TEST_FUNC_V5_C12_T2_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C12_T3_RESULT") === -2147483647);
	assert(sim.signalValue("#TEST_FUNC_V5_C12_T3_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C12_T4_RESULT") === -2147483648);
	assert(sim.signalValue("#TEST_FUNC_V5_C12_T4_RZ") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C12_T5_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C12_T5_RZ") === 1);

	// conf 13 -> sign, nan, inf
	//
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T1_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T2_RESULT") === 1);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T3_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T4_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T5_RESULT") === 1);

	assert(sim.signalValue("#TEST_FUNC_V5_C13_T10_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T11_RESULT") === 1);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T12_RESULT") === 0);

	assert(sim.signalValue("#TEST_FUNC_V5_C13_T21_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T22_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T23_RESULT") === 1);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T24_RESULT") === 1);

	assert(sim.signalValue("#TEST_FUNC_V5_C13_T41_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T42_RESULT") === 0);
	assert(sim.signalValue("#TEST_FUNC_V5_C13_T43_RESULT") === 1);
