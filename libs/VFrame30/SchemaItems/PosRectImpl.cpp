...
namespace VFrame30
{
	...
	void PosRectImpl::propertyDemand(const QString& prop)
	{
		...
		{
			auto p = addProperty<double, PosRectImpl, &PosRectImpl::left, &PosRectImpl::setLeft>(PropertyNames::left,
		...
		{
			auto p = addProperty<double, PosRectImpl, &PosRectImpl::top, &PosRectImpl::setTop>(PropertyNames::top,
																							   PropertyNames::positionAndSizeCategory,
																							   true);
			p->setPrecision(precision);
			p->setViewOrder(1);
		...
		{
			auto p = addProperty<double, PosRectImpl, &PosRectImpl::width, &PosRectImpl::setWidth>(PropertyNames::width,
																								   PropertyNames::positionAndSizeCategory,
																								   true);
			p->setPrecision(precision);
			p->setViewOrder(2);
		...
		{
			auto p = addProperty<double, PosRectImpl, &PosRectImpl::height, &PosRectImpl::setHeight>(PropertyNames::height,
																									 PropertyNames::positionAndSizeCategory,
																									 true);
			p->setPrecision(precision);
			p->setViewOrder(3);
