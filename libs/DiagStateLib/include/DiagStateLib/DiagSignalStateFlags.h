...
union DiagSignalStateFlags
{
	struct
	{
		...
		quint32 stateAvailable : 1;			//	1	sets to 1 if diagnostic data received from LM
		...
		quint32 archive: 1;					//	30	point should be send to archive
	...
	void updateArchivingReasonFlags(const DiagSignalStateFlags& prevFlags);
