...
#include "DiagStateLib/DiagSignalStateFlags.h"
...
void DiagSignalStateFlags::setFlag(E::AppSignalStateFlagType flagType, quint32 value)
{
...
void DiagSignalStateFlags::clear()
{
	all = 0;
}

void DiagSignalStateFlags::clearReasonsFlags()
{
	all &= ~MASK_ALL_ARCHIVING_REASONS;
}

bool DiagSignalStateFlags::hasArchivingReason() const
{
	return (all & MASK_ALL_ARCHIVING_REASONS) != 0;
}

bool DiagSignalStateFlags::hasShortTermArchivingReasonOnly() const
{
...
bool DiagSignalStateFlags::hasAutoPointReasonOnly() const
{
	quint32 archivingReasons = all & MASK_ALL_ARCHIVING_REASONS;
...
void DiagSignalStateFlags::updateArchivingReasonFlags(const DiagSignalStateFlags& prevFlags)
{
...
QString DiagSignalStateFlags::print()
{
