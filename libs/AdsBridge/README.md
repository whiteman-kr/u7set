...
A CMake-packaged SDK for integrating **AdsBridge** into C++ projects.  
The layout follows the de-facto standard for CMake export packages.
...
|-- lib/                           # Static (.a/.lib)
+-- share/
    |-- cmake/                     # *AdsBridgeConfig*.cmake & version files
    +-- doc/AdsBridge/             # Docs & API reference
```
