...
namespace SimUi
{
		...
		SimBasePage(simulator, parent)
	{
		...
		m_schemaListWidget = new SchemaClientLib::SchemaListWidget{{SchemaClientLib::SchemaListTreeColumns::SchemaID,
																	SchemaClientLib::SchemaListTreeColumns::Caption,
																	SchemaClientLib::SchemaListTreeColumns::Tags,
																	SchemaClientLib::SchemaListTreeColumns::Modules},
																   true,
																   parent};
