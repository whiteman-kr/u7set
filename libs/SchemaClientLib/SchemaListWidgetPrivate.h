...
namespace SchemaClientLib
{
	...
	public:
		SchemaListTreeWidget(std::vector<SchemaClientLib::SchemaListTreeColumns> columns, QWidget* parent);
	...
	//
	//
	class SchemaListWidgetPrivate : public QWidget
	{
		Q_OBJECT

	public:
		explicit SchemaListWidgetPrivate(std::vector<SchemaClientLib::SchemaListTreeColumns> columns, bool showTags, QWidget* parent);
		virtual ~SchemaListWidgetPrivate() = default;
