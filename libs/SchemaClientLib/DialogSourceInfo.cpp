...
namespace SchemaClientLib
{
	...
	DialogSourceInfo::DialogSourceInfo(QWidget* parent, quint64 dialogId) :
	...
	void DialogSourceInfo::setDataItemNumberCompare(QTreeWidgetItem* parentItem,
													const QString& caption,
													quint64 number,
													quint64 previousNumber)
	{
