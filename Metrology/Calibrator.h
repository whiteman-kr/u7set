...
const CalibratorLimit CalibratorLimits[] =
{
	...
	{ CALIBRATOR_TYPE_TRXII,	CALIBRATOR_MODE_MEASURE,	0,  2000,	CALIBRATOR_UNIT_HZ,			2,	0.00,	0.00	,":MEASURE:FREQ Hz,5.00"},
	...
	{ CALIBRATOR_TYPE_CALYS75,	CALIBRATOR_MODE_MEASURE,	0, 20000,	CALIBRATOR_UNIT_HZ,			3,	0.000,	0.000	,"SENS:FUNC FREQ\r\nSENS:FREQ:RANG 20KHZ"},			//
