...
MeasureViewColumn MeasureViewHeader::m_column[MEASURE_TYPE_COUNT][MEASURE_VIEW_COLUMN_COUNT] =
{
...

    {
        ...
        MeasureViewColumn( QT_TRANSLATE_NOOP("MeasureViewHeader", "Adjustment"), 100, MVC_CMN_SHOW, Qt::AlignHCenter, MVC_CMN_NO_BOLD, MVC_CMN_COLOR_WHITE, MVC_CMN_DISABLE_DUPLICATE),
