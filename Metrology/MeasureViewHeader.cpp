...
MeasureViewColumn MeasureViewHeader::m_column[MEASURE_TYPE_COUNT][MEASURE_VIEW_COLUMN_COUNT] =
{
...

    {
        ...
        MeasureViewColumn( QT_TRANSLATE_NOOP("MeasureViewHeader", "Case"), 100, MVC_CMN_SHOW, Qt::AlignHCenter, MVC_CMN_DISABLE_DUPLICATE),
        ...
        MeasureViewColumn( QT_TRANSLATE_NOOP("MeasureViewHeader", "Subblock"), 60, MVC_CMN_SHOW, Qt::AlignHCenter, MVC_CMN_DISABLE_DUPLICATE),
        MeasureViewColumn( QT_TRANSLATE_NOOP("MeasureViewHeader", "Block"), 60, MVC_CMN_SHOW, Qt::AlignHCenter, MVC_CMN_DISABLE_DUPLICATE),
        MeasureViewColumn( QT_TRANSLATE_NOOP("MeasureViewHeader", "Entry"), 60, MVC_CMN_SHOW, Qt::AlignHCenter, MVC_CMN_DISABLE_DUPLICATE),
