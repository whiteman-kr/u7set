...
const int				MVC_CMN_L_INDEX				= 0,
						...
						MVC_CMN_L_SD				= 20,
						MVC_CMN_L_LOW_BORDER		= 21,
						MVC_CMN_L_HIGH_BORDER		= 22,
						MVC_CMN_L_UNCERTAINTY		= 23,
						MVC_CMN_L_VALUE_COUNT		= 24,
						MVC_CMN_L_VALUE_0			= 25,
						MVC_CMN_L_VALUE_1			= 26,
						MVC_CMN_L_VALUE_2			= 27,
						MVC_CMN_L_VALUE_3			= 28,
						MVC_CMN_L_VALUE_4			= 29,
						MVC_CMN_L_VALUE_5			= 30,
						MVC_CMN_L_VALUE_6			= 31,
						MVC_CMN_L_VALUE_7			= 32,
						MVC_CMN_L_VALUE_8			= 33,
						MVC_CMN_L_VALUE_9			= 34,
						MVC_CMN_L_VALUE_10			= 35,
						MVC_CMN_L_VALUE_11			= 36,
						MVC_CMN_L_VALUE_12			= 37,
						MVC_CMN_L_VALUE_13			= 38,
						MVC_CMN_L_VALUE_14			= 39,
						MVC_CMN_L_VALUE_15			= 40,
						MVC_CMN_L_VALUE_16			= 41,
						MVC_CMN_L_VALUE_17			= 42,
						MVC_CMN_L_VALUE_18			= 43,
						MVC_CMN_L_VALUE_19			= 44,
						MVC_CMN_L_ERROR				= 45,
						MVC_CMN_L_ERROR_LIMIT		= 46,
						MVC_CMN_L_ERROR_RESULT		= 47,
						MVC_CMN_L_MEASUREMENT_TIME	= 48,
						MVC_CMN_L_CALIBRATOR		= 49;
