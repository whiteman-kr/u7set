...
const char* const       SignalInfoColumn[] =
{
                        ...
                        QT_TRANSLATE_NOOP("SignalInfoMeasure.h", "Adjustment"),
...
const int               SIGNAL_INFO_COLUMN_CASE         = 0,
                        ...
                        SIGNAL_INFO_COLUMN_ADJUSTMENT   = 7,
                        SIGNAL_INFO_COLUMN_IN_PH_RANGE  = 8,
                        SIGNAL_INFO_COLUMN_IN_EL_RANGE  = 9,
                        SIGNAL_INFO_COLUMN_CALIBRATOR   = 10,
                        SIGNAL_INFO_COLUMN_OUT_PH_RANGE = 11,
                        SIGNAL_INFO_COLUMN_OUT_EL_RANGE = 12;
...
public:
    ...
    void                set(MeasureMultiSignal& signal);
    void                clear();
