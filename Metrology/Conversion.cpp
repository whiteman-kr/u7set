			...
			switch(param.electricUnitID())
			{
				case E::ElectricUnit::Ohm:
					...
					switch(param.electricSensorType())
					{
						...
						case E::SensorType::Ohm_Ni50_W1617:		retVal = findConversionVal(val, &NI_50_W_1617[0][0], NI_50_W_1617_COUNT, true);		break;
						case E::SensorType::Ohm_Ni100_W1617:	retVal = findConversionVal(val, &NI_100_W_1617[0][0], NI_100_W_1617_COUNT, true);	break;
			...
			switch(param.electricUnitID())
			{
				case E::ElectricUnit::Ohm:
					...
					switch(param.electricSensorType())
					{
						...
						case E::SensorType::Ohm_Ni50_W1617:		retVal = findConversionVal(val, &NI_50_W_1617[0][0], NI_50_W_1617_COUNT, false);	break;
						case E::SensorType::Ohm_Ni100_W1617:	retVal = findConversionVal(val, &NI_100_W_1617[0][0], NI_100_W_1617_COUNT, false);	break;
