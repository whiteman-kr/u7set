...
namespace Hardware
{
	...
	bool Connection::LoadData(const Proto::Envelope& message)
	{
		...
		m_port1EquipmentID = QString::fromStdString(connection.port1equipmentid());
		m_port2EquipmentID = QString::fromStdString(connection.port2equipmentid());
		m_port1RawDataDescription = QString::fromStdString(connection.port1rawdatadescription());
		m_port2RawDataDescription = QString::fromStdString(connection.port2rawdatadescription());
