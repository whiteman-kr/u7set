...
public:
    ...
    virtual bool evaluate( QString& exp, NCReportSection* section=0 );
    virtual bool evaluate( QString& exp, NCReportItem::SourceType stype, NCReportSection* section=0 );
    virtual bool evaluateScript( QString& exp );
...
protected:
    ...
    QString getFieldDisplayValue( const QString& id, NCReportSection *section );
    ...
    QString parseExpression( const QString& expression, const QString& tokenBegin, const QString &tokenEnd, int &tokenBeginPos, int &tokenLength ) const;
