...
public:
    ...
    //enum FieldType { DataSource=0, Parameter, Variable, SysVar, Expression, Template };
    enum SwapMode { OriginalValue=0 ,LastValue };

//	inline FieldType fieldType() const
//	{ return (FieldType)((NCReportFieldData*)d)->fieldtype; }

//	inline void setFieldType( const FieldType type )
//	{ ((NCReportFieldData*)d)->fieldtype = type; }
