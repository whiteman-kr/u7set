	...
	ui(new Ui::DialogSettings)
{
	...
	if (okButton != nullptr)
	{
		okButton->setEnabled(DiagnosticsAppSettings::instance().wasLoadedFromFile() == false);
	}
	else
	{
		Q_ASSERT(okButton);
...
const DiagnosticsAppSettings::Data& DialogSettings::settings() const
{
	return m_settings;
}

void DialogSettings::setSettings(const DiagnosticsAppSettings::Data& value)
{
	m_settings = value;
...
std::optional<DiagnosticsAppSettings::Data> DialogSettings::parseData()
{
	...
	// --
	//
	DiagnosticsAppSettings::Data data;
