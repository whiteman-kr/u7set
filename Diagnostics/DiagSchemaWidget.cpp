...

{
	...
	connect(this, &QWidget::customContextMenuRequested, this, &DiagSchemaWidget::contextMenuRequested);
...
DiagSchemaWidget::~DiagSchemaWidget()
{
	qDebug() << Q_FUNC_INFO;
}
...
DiagSchemaView* DiagSchemaWidget::diagSchemaView()
{
	auto result = dynamic_cast<DiagSchemaView*>(schemaView());
	Q_ASSERT(result);
	return result;
}

const DiagSchemaView* DiagSchemaWidget::diagSchemaView() const
{
	auto result = dynamic_cast<const DiagSchemaView*>(schemaView());
	Q_ASSERT(result);
	return result;
}
...
{
	return diagSchemaView()->diagSchemaManager();
}

const DiagnosticsSchemaManager* DiagSchemaWidget::schemaManager() const
{
	return diagSchemaView()->diagSchemaManager();
}
