...
copy "..\bin\release\docs\D11.6 RPCT User Manual Appendix A Warnings and Errors List.pdf" packages\u7set.develop.rpct.docs\data\docs\Appendixes
copy "..\bin\release\docs\D11.6 RPCT User Manual Appendix B Build Directory and Output Bitstream File Description.pdf" packages\u7set.develop.rpct.docs\data\docs\Appendixes
copy "..\bin\release\docs\D11.6 RPCT User Manual Appendix C JavaScript Manual.pdf" packages\u7set.develop.rpct.docs\data\docs\Appendixes
