...
function cleanup(sim)
{
	...
	//Test
	//Schema AFB_BUS_NOT element tests


function test_NOT_BUS_5_Signal_1(sim)
{
	...
	sim.startForMs(5);
	assert(sim.signalValue("#OUT_BUS_NOT_01") === 0);
	assert(sim.signalValue("#OUT_BUS_NOT_02") === 0);
	assert(sim.signalValue("#OUT_BUS_NOT_03") === 0);
	assert(sim.signalValue("#OUT_BUS_NOT_04") === 0);
	assert(sim.signalValue("#OUT_BUS_NOT_05") === 0);

}


function test_NOT_BUS_5_Signal_0(sim)
{
	...
	sim.startForMs(5);
	assert(sim.signalValue("#OUT_BUS_NOT_01") === 1);
	assert(sim.signalValue("#OUT_BUS_NOT_02") === 1);
	assert(sim.signalValue("#OUT_BUS_NOT_03") === 1);
	assert(sim.signalValue("#OUT_BUS_NOT_04") === 1);
	assert(sim.signalValue("#OUT_BUS_NOT_05") === 1);

}

function test_NOT_BUS_5_Signal_0_1(sim)
{
