...
private:
	...
	void addBus(const std::shared_ptr<AppSignalLib::Bus> bus);
	void addBus(const std::vector<std::shared_ptr<AppSignalLib::Bus>> busses);

	void updateButtonsEnableState();
	void updateBusTreeItemText(QTreeWidgetItem* item);
	void updateBusTreeItemText(QTreeWidgetItem* item, const AppSignalLib::Bus* bus);
	void updateSignalsTreeItemText(QTreeWidgetItem* item, const AppSignalLib::BusSignal& signal);

	AppSignalLib::Bus* getCurrentBus(QUuid* uuid = nullptr);
