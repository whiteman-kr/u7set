...
namespace Builder
{
	...
	private:
		...
		bool writeBinCodeForLm(QString subsystemID, int subsystemKey, std::shared_ptr<LmDescription> lmDescription, QString lmEquipmentID, int lmNumber, int frameSize, int frameCount, quint64 uniqueID, ApplicationLogicCode& appLogicCode);
