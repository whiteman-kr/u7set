...
namespace Hardware
{
    ...
    const int Connection::index() const
    {
        return m_index;
    }
    ...
    const QString Connection::caption() const
    {
        return m_caption;
    }
    ...
    const QString Connection::device1StrID() const
    {
    ...
    const int Connection::device1Port() const
    {
    ...
    const QString Connection::device2StrID() const
    {
    ...
    const int Connection::device2Port() const
    {
    ...
    const int Connection::txStartAddress() const
    {
    ...
    const int Connection::txWordsQuantity() const
    {
    ...
    const int Connection::rxWordsQuantity() const
    {
    ...
    const Connection::ConnectionMode Connection::connectionMode() const
    {
    ...
    const bool Connection::enable() const
    {
        return m_enable;
    }
