...
//
//
class EditSchemaDiagStateProvider final : public IDiagStateManager
{
public:
	//EditSchemaDiagStateProvider() = delete;
	EditSchemaDiagStateProvider(/*AppSignalSetProvider* signalSetProvider*/);
