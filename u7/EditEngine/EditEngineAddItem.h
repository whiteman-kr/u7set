...
namespace EditEngine
{
	...
	public:
		AddItemCommand(EditSchemaView* schemeView, std::list<std::shared_ptr<VFrame30::SchemaItem>> items, std::shared_ptr<VFrame30::SchemaLayer> layer, QScrollBar* hScrollBar, QScrollBar* vScrollBar);
