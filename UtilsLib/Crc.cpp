...
namespace
{
	// Table was generated here: http://www.sunshine2k.de/coding/javascript/crc/crc_js.html
	// CRC width: 64
	// Input reflected: false
	// Result reflected: false
	// Polinomial: 0x000000000000001B
	// Initial value: 0xFFFFFFFFFFFFFFFF
	// Final Xor value: 0
	//
	constexpr std::array<quint64, 256> crc64Table =
	{
...
// This implementation is changed to the table version.
//
...
{
	const unsigned char* p = static_cast<const unsigned char*>(src);
	quint64 crc = 0xFFFFFFFFFFFFFFFF;

	while (size--)
	{
		crc = crc64Table[(crc >> 56) ^ *p++] ^ (crc << 8);
	}
