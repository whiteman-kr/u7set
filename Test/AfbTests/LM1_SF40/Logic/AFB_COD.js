...
function test_AFB_COD(sim)
{
    ...
    assert(sim.signalValue("#OUT_COD_SI001") === 0);
...
function test_AFB_2COD(sim)
{
    ...
    assert(sim.signalValue("#OUT_COD_SI002") === 0);
    ...
    assert(sim.signalValue("#OUT_COD_SI002") === 1);
    assert(sim.signalValue("#ACTIVE_COD_OUT2") === 1);

    return;
}

function test_AFB_3COD(sim)
{
	// Schema AFB_COD
    ...
    assert(sim.signalValue("#OUT_COD_SI003") === 0);
    assert(sim.signalValue("#ACTIVE_COD_OUT3") === 0);
    ...
    assert(sim.signalValue("#OUT_COD_SI003") === 0);
    assert(sim.signalValue("#ACTIVE_COD_OUT3") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI003") === 2);
    assert(sim.signalValue("#ACTIVE_COD_OUT3") === 1);
...
function test_AFB_4COD(sim)
{
    ...
    assert(sim.signalValue("#OUT_COD_SI004") === 0);
    ...
    assert(sim.signalValue("#OUT_COD_SI004") === 2);
    assert(sim.signalValue("#ACTIVE_COD_OUT4") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI004") === 3);
    assert(sim.signalValue("#ACTIVE_COD_OUT4") === 1);
...
function test_AFB_9COD(sim)
{
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 0);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 1);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 2);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 3);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 4);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 5);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 6);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 7);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1);
    ...
    assert(sim.signalValue("#OUT_COD_SI009") === 8);
    assert(sim.signalValue("#ACTIVE_COD_OUT9") ===1); 
...
function test_AFB_16COD(sim)
{
    ...
    assert(sim.signalValue("#OUT_COD_SI0016") === 0);
    ...
    assert(sim.signalValue("#OUT_COD_SI0016") === 1);
    assert(sim.signalValue("#ACTIVE_COD_OUT16") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI0016") === 2);
    assert(sim.signalValue("#ACTIVE_COD_OUT16") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI0016") === 3);
    assert(sim.signalValue("#ACTIVE_COD_OUT16") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI0016") === 6);
    assert(sim.signalValue("#ACTIVE_COD_OUT16") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI0016") === 11);
    assert(sim.signalValue("#ACTIVE_COD_OUT16") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI0016") === 15);
    assert(sim.signalValue("#ACTIVE_COD_OUT16") === 1);
...
function test_AFB_32COD(sim)
{
    ...
    assert(sim.signalValue("#OUT_COD_SI0032") === 0);
    ...
    assert(sim.signalValue("#OUT_COD_SI0032") === 7);
    ...
    assert(sim.signalValue("#OUT_COD_SI0032") === 4);
    assert(sim.signalValue("#ACTIVE_COD_OUT32") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI0032") === 31);
    assert(sim.signalValue("#ACTIVE_COD_OUT32") === 1);
    ...
    assert(sim.signalValue("#OUT_COD_SI0032") === 28);
    assert(sim.signalValue("#ACTIVE_COD_OUT32") === 1);
