...
function test_OR_BUS_5_Signal_1_1(sim)
{
	...
	sim.startForMs(5);
	assert(sim.signalValue("#OUT_BUS_2OR_01") === 1);
	assert(sim.signalValue("#OUT_BUS_2OR_02") === 1);
	assert(sim.signalValue("#OUT_BUS_2OR_03") === 1);
	assert(sim.signalValue("#OUT_BUS_2OR_04") === 1);
	assert(sim.signalValue("#OUT_BUS_2OR_05") === 1);
	
}


function test_OR_BUS_5_Signal_0_0(sim)
{
	...
	sim.startForMs(5);
	assert(sim.signalValue("#OUT_BUS_2OR_01") === 0);
	assert(sim.signalValue("#OUT_BUS_2OR_02") === 0);
	assert(sim.signalValue("#OUT_BUS_2OR_03") === 0);
	assert(sim.signalValue("#OUT_BUS_2OR_04") === 0);
	assert(sim.signalValue("#OUT_BUS_2OR_05") === 0);
	
}


function test_OR_BUS_5_Signal_0_1(sim)
{
...
function test_OR_BUS_5_Signal_1_0(sim)
{
...
function test_OR_BUS_5_Signal_1_0_1(sim)
{
