...
function test_AFB_CNT_UP(sim)
{
    ...
    sim.startForMs(15);
    console.log(sim.signalValue("#OUT_CNT_UP1"));
    assert(sim.signalValue("#OUT_CNT_UP1") === 1);
    ...
    assert(sim.signalValue("#OUT_CNT_UP1") === 2);
   ...
   sim.overrideSignalValue("#TUN_DSCR1", 1);
    ...
    sim.startForMs(5);
    console.log(sim.signalValue("#OUT_CNT_UP1"));
    assert(sim.signalValue("#OUT_CNT_UP1") === 3);
