...
function test_XOR_BUS_5_Signal_1_1(sim)
{
	...
	sim.startForMs(5);
	assert(sim.signalValue("#OUT_BUS_2XOR_01") === 0);
	assert(sim.signalValue("#OUT_BUS_2XOR_02") === 0);
	assert(sim.signalValue("#OUT_BUS_2XOR_03") === 0);
	assert(sim.signalValue("#OUT_BUS_2XOR_04") === 0);
	assert(sim.signalValue("#OUT_BUS_2XOR_05") === 0);
	
}

function test_XOR_BUS_5_Signal_0_0(sim)
{
...
function test_XOR_BUS_5_Signal_0_1(sim)
{
	...
	sim.startForMs(5);
	assert(sim.signalValue("#OUT_BUS_2XOR_01") === 1);
	assert(sim.signalValue("#OUT_BUS_2XOR_02") === 1);
	assert(sim.signalValue("#OUT_BUS_2XOR_03") === 1);
	assert(sim.signalValue("#OUT_BUS_2XOR_04") === 1);
	assert(sim.signalValue("#OUT_BUS_2XOR_05") === 1);
	
}

function test_XOR_BUS_5_Signal_1_0(sim)
{
...
function test_XOR_BUS_5_Signal_1_0_1(sim)
{
