...
const QString SignalProperties::lowEngineeringUnitsCaption("LowEngeneeringUnits");
const QString SignalProperties::highEngineeringUnitsCaption("HighEngeneeringUnits");
