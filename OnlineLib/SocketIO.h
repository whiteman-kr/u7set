...
const quint16   PORT_BASE_SERVICE = 13300,
				...
				PORT_TCP_APP_DATA_SERVICE = 13329,
				PORT_APP_DATA_SERVICE_GRPC_CLIENT_REQUEST = 14323,

				PORT_TUNING_SERVICE = 13330,
				PORT_TUNING_SERVICE_DATA = 13332,
				PORT_TUNING_SERVICE_CLIENT_REQUEST = 13333,
				PORT_TCP_TUNING_SERVICE = 13339,
				...
				PORT_TCP_ARCHIVING_SERVICE = 13349,
				...
				PORT_DIAG_DATA_SERVICE_RT_TRENDS_REQUEST = 13354,
				PORT_TCP_DIAG_DATA_SERVICE = 13359,

				PORT_GATEWAY_SERVICE = 13360,
				PORT_GATEWAY_SERVICE_INFO = 13361,
				PORT_TCP_GATEWAY_SERVICE = 13369;
...
const quint32 ADS_GET_GATEWAY_APP_SIGNAL_STATE_CHANGES = 0x1306;
...
const int ADS_GET_APP_SIGNAL_STATE_MAX = 5000;
const int ADS_GET_DISCRETES_LOG_MAX_RECORD_COUNT = 5000;
...
const quint32 TDS_GET_SIGNALS_STATE_CHANGES = 0x150C;
const quint32 TDS_GET_TUNING_SOURCES_FILE = 0x1510;

const int TDS_TUNING_MAX_READ_STATES = 1000;
const int TDS_TUNING_MAX_WRITE_RECORDS = 1000;
const quint64 TDS_TUNING_SOURCES_FILE_PART_SIZE = 1024 * 1024;		//	 1Mb
